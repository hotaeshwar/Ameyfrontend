  ...
  return (
    <div className="container mx-auto px-4 py-8 bg-gradient-to-br from-gray-50 to-indigo-50 min-h-screen">
      <div className="bg-white rounded-xl shadow-lg p-6 border border-indigo-100">
        ...
        <div className={`grid grid-cols-1 ${role === 'admin' ? 'md:grid-cols-3' : 'md:grid-cols-2'} gap-4 mb-8`}>
          {/* Income Card - Only visible to admin */}
          {role === 'admin' && (
          ...
          {/* Net Profit/Loss Card - Only visible to admin */}
          {role === 'admin' && (
