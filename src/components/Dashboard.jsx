...
const Dashboard = () => {
  ...
  const [userRole, setUserRole] = useState('guest') // Add user role state
  ...
  return (
    <div className="container mx-auto px-4 py-8 bg-gradient-to-br from-gray-50 to-indigo-50 min-h-screen">
      <div className="bg-white rounded-xl shadow-lg p-6 border border-indigo-100">
        ...
        <div className={`grid grid-cols-1 ${userRole === 'admin' ? 'md:grid-cols-3' : 'md:grid-cols-1'} gap-4 mb-8`}>
          ...
          {/* Net Profit/Loss Card - Admin Only */}
          {userRole === 'admin' && (
